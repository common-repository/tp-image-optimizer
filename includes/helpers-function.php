...
if (!function_exists('tpfw_notice_admin')){
	function tpfw_notice_admin(){
		...
		$logo = sprintf('<img style="width: 30px;height:auto;vertical-align: middle;" src="%s" alt="logo-themepond">',TP_IMAGE_OPTIMIZER_URL.'/assets/images/logo-tp.png');
		$class = 'notice tp-notice';
		$message = sprintf(__('Explore more about our products such as: PSD Templates, Premium Plugins, WordPress Themes,... on ThemesPond. <a href="%s" target="_blank">View Now!</a>','tp-image-optimizer'),esc_url('https://www.themespond.com/'));
